package com.leontsai.commonsdk.core.hub;
...
public interface RouterHub {
     ...
     * start
     */
    String START_SERVICE_STARTINFOSERVICE = START + SERVICE + "/StartInfoService";

    String START_MAINACTIVITY = START + "/MainActivity";
    String START_DETAILACTIVITY = START + "/DetailActivity";
    ...
    String HOME_MAINACTIVITY = HOME + "/MainActivity";

    /**
     * other
     */
    String OTHER_SERVICE_GOLDINFOSERVICE = OTHER + SERVICE + "/OtherInfoService";

    String OTHER_MAINACTIVITY = OTHER + "/MainActivity";
    String OTHER_DETAILACTIVITY = OTHER + "/DetailActivity";
}
